...
/*
   WORKLOG
      (01/01/02)
         - does the loading of non-16x16 font maps even work?
         - does it even matter?  never used it...useless feature
      (06/25/01)
         - Fixed an annoying scissor bug thanks to Christopher Kocmoud
           (c-kocmoud@tamu.edu)
      (06/16/01)
         - Fixed a viewport bug thanks to Reid Simmons(reids+@cs.cmu.edu).
      (10/28/00)
         - fixed region bug
      (10/19/00)
...
struct GLFont
{
   ...
   void GradientColor3fv(const GLfloat *clr)
    {ColorSet(colorGrad, clr, 3);}
   void GradientColor3ubv(const GLubyte *clr)
   ...
   void GradientColor4ub(GLubyte r, GLubyte g, GLubyte b, GLubyte a)
    {ColorSet(colorGrad, r, g, b, a);}
   void GradientColor4fv(const GLfloat *clr)
    {ColorSet(colorGrad, clr, 4);}
   void GradientColor4ubv(const GLubyte *clr)
   ...
   void ShadowColor3fv(const GLfloat *clr)
    {ColorSet(colorShadow, clr, 3);}
   void ShadowColor3ubv(const GLubyte *clr)
   ...
   void ShadowColor4ub(GLubyte r, GLubyte g, GLubyte b, GLubyte a)
    {ColorSet(colorShadow, r, g, b, a);}
   void  ShadowColor4fv(const GLfloat *clr)
    {ColorSet(colorShadow, clr, 4);}
   void ShadowColor4ubv(const GLubyte *clr)
